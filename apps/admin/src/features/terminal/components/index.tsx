  ...
  return (
    <>
      <div className="flex size-full items-center justify-center">
        ...
        >
          <div className="size-full bg-background/50 p-10">
      ...
      <div
        className={cn(
          "absolute -bottom-32 left-1/2 z-10 flex -translate-x-1/2 flex-col gap-2 rounded-md border-primary bg-primary px-4 py-2 text-4xl opacity-0 transition-opacity group-hover:opacity-100 text-white",
